...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.controlPane)
        ...
        self.prevTimeStep = QtWidgets.QPushButton(self.groupBox_2)
        ...
        self.timeStepSelector = QtWidgets.QComboBox(self.groupBox_2)
        font = QtGui.QFont()
        ...
        self.nextTimeStep = QtWidgets.QPushButton(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.groupBox_5 = QtWidgets.QGroupBox(self.controlPane)
        ...
        self.gsSpinBox = QtWidgets.QDoubleSpinBox(self.groupBox_5)
        self.gsSpinBox.setMinimumSize(QtCore.QSize(80, 0))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(9)
        self.gsSpinBox.setFont(font)
        self.gsSpinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.UpDownArrows)
        self.gsSpinBox.setDecimals(4)
        self.gsSpinBox.setMinimum(0.0)
        self.gsSpinBox.setMaximum(9999999.0)
        self.gsSpinBox.setSingleStep(0.005)
        self.gsSpinBox.setProperty("value", 0.001)
        self.gsSpinBox.setObjectName("gsSpinBox")
        self.horizontalLayout_10.addWidget(self.gsSpinBox)
        self.controls.addWidget(self.groupBox_5)
        self.groupBox = QtWidgets.QGroupBox(self.controlPane)
        ...
        self.exagSpinBox = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.exagSpinBox.setMinimumSize(QtCore.QSize(80, 0))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(9)
        self.exagSpinBox.setFont(font)
        self.exagSpinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.UpDownArrows)
        self.exagSpinBox.setDecimals(1)
        self.exagSpinBox.setMinimum(0.0)
        self.exagSpinBox.setMaximum(1000.0)
        self.exagSpinBox.setSingleStep(1.0)
        self.exagSpinBox.setProperty("value", 0.0)
        self.exagSpinBox.setObjectName("exagSpinBox")
        self.verticalLayout.addWidget(self.exagSpinBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Time Step"))
        ...
        self.groupBox_5.setTitle(_translate("MainWindow", "Grid Spacing"))
        self.groupBox.setTitle(_translate("MainWindow", "Exaggeration"))
